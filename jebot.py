...
I can download video or audio from Youtube, Pornhub and Xhamster. Made by @SuryaPrabhas.
Hit help button to find out more about how to use me</b>""",   
                            reply_markup=InlineKeyboardMarkup(
                                [[
                                        ...
                                        InlineKeyboardButton(
                                            "Join 🔥", url="https://t.me/TeluguDubbedHorrorMovies2")
                                    ],[
                                      InlineKeyboardButton(
                                            "Source Code ⚡", url="https://github.com/suryaprabhas1245/AnyDLBot")
                                    ]]
                            ),        
...
<b>♞ Developer:</b> <a href="https://t.me/suryaprabhas1245">Surya Prabhas</a>
<b>♞ Support:</b> <a href="https://t.me/TeluguDubbedHorrorMovies2">Support Group</a>
<b>♞ Library:</b> <a href="https://github.com/pyrogram/pyrogram">Pyrogram</a>
<b>Join @TeluguDubbedHorrorMovies2</b>""",
     reply_markup=InlineKeyboardMarkup(
                                [[
                                        InlineKeyboardButton(
        ...
        try:
            ...
            if user.status == "kicked":
                await c.send_message(
                    chat_id=message.chat.id,
                    text="Sorry, You are Banned to use me. Contact my [Developer](https://t.me/SuryaPrabhas1245).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
...
print(
    """
Bot Started!
Join @TeluguDubbedHorrorMovies2
"""
)
